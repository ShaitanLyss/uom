...
//! HydraulicPermeability (base unit square meter, m²).
quantity! {
    /// HydraulicPermeability (base unit square meter, m²).
    quantity: HydraulicPermeability; "hydraulic permeability";
    /// Dimension of hydraulic permeability, L² (base unit square meter, m²).
    dimension: ISQ<
        P2,     // length
        Z0,     // mass
        Z0,     // time
    ...
    kind: dyn (crate::si::marker::HydraulicPermeabilityKind);
    units {
        ...
        @darcy: 9.869_233_E-13; "D", "darcy", "darcys";
        @millidarcy: 9.869_233_E-16; "mD", "millidarcy", "millidarcys";
    }
}
...
//    storage_types! {
//        use crate::num::One;
//        use crate::si::hydraulic_permeability as a;
...
//        #[test]
//        fn check_dimension() {
//            let _: HydraulicPermeability<V> = Length::new::<l::meter>(V::one()) * Length::new::<l::meter>(V::one());
//        }
//
//        #[test]
...
//                if A::is_valid() {
//                    Test::assert_eq(&HydraulicPermeability::new::<A>(V::one()),
